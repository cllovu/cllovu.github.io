function McEChartsTreemap(){
    //___mcUtils参考mc-utils.js
    this.mcUtils = ___mcUtils;
    this.param = null;
    this.domClass = "mc-echarts-treemap";
}
/*务必带此render方法：否则组件不会被追踪渲染*/
McEChartsTreemap.prototype.render = function(param){
...
McEChartsTreemap.prototype.treemap = function () {
    var _t = this;
...
McEChartsTreemap.prototype.getTitle = function(echartsDom){
...
McEChartsTreemap.prototype.setOption = function(option,param,data){
    ...
    for(var j=0;j<dataList.length;j++){
        var item = dataList[j];
        seriesData.push({children:item[yFieldName],value:item[xFieldName]});
    }
...
/*把组件安装一下*/
___mcUtils.install({component:new McEChartsTreemap()})
