function McEChartsGradeGauge(){
    //___mcUtils参考mc-utils.js
    this.mcUtils = ___mcUtils;
    this.param = null;
    this.domClass = "mc-echarts-grade-gauge";
}
/*务必带此render方法：否则组件不会被追踪渲染*/
McEChartsGradeGauge.prototype.render = function(param){
...
McEChartsGradeGauge.prototype.gradeGauge = function () {
    var _t = this;
...
McEChartsGradeGauge.prototype.getTitle = function(echartsDom){
...
McEChartsGradeGauge.prototype.setOption = function(option,param,data){
...
/*把组件安装一下*/
___mcUtils.install({component:new McEChartsGradeGauge()})
