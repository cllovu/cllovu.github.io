function McEChartsTree(){
    //___mcUtils参考mc-utils.js
    this.mcUtils = ___mcUtils;
    this.param = null;
    this.domClass = "mc-echarts-tree";
}
/*务必带此render方法：否则组件不会被追踪渲染*/
McEChartsTree.prototype.render = function(param){
...
McEChartsTree.prototype.tree = function () {
    var _t = this;
...
McEChartsTree.prototype.getTitle = function(echartsDom){
...
McEChartsTree.prototype.setOption = function(option,param,data){
    ...
    for(var j=0;j<dataList.length;j++){
        var item = dataList[j];
        seriesData.push({children:item[yFieldName],name:item[xFieldName]});
    }
...
/*把组件安装一下*/
___mcUtils.install({component:new McEChartsTree()})
