...
/*这里是简单的浅拷贝，没递归往下继续遍历 所以适用场景有限，请自行改造*/
McECharts.prototype.combineSeries = function(option,userConfigOption){
    ...
    // var xAxis = userConfigOption.xAxis;
...
McECharts.prototype.ajaxRequestData = function(param,remoteApi,callback){
    if(typeof axios!='undefined'){//ie下会出现问题
        //用axios请求
